...
if ( !class_exists('Inbound_Email_Templates_Post_Type') ) {
	...
	class Inbound_Core_Email_Templates_Post_Type {
		...
		public static function register_post_type() {
			...
			$labels = array(
				...
				'singular_name' => __( 'Email Templates', 'inbound-legacy-email-templates' ),
				'add_new' => __( 'Add New Email Templates', 'inbound-legacy-email-templates' ),
				'add_new_item' => __( 'Create New Email Templates' , 'inbound-legacy-email-templates' ),
				'edit_item' => __( 'Edit Email Templates' , 'inbound-legacy-email-templates' ),
				'new_item' => __( 'New Email Templates' , 'inbound-legacy-email-templates' ),
				'view_item' => __( 'View Email Templates' , 'inbound-legacy-email-templates' ),
				'search_items' => __( 'Search Email Templates' , 'inbound-legacy-email-templates' ),
				'not_found' =>	__( 'Nothing found' , 'inbound-legacy-email-templates' ),
				'not_found_in_trash' => __( 'Nothing found in Trash' , 'inbound-legacy-email-templates' ),
				'parent_item_colon' => ''
			);
		...
		public static function register_columns( $cols ) {
			...
			$cols = array(
				...
				"title" => __( 'Email Templates' , 'inbound-legacy-email-templates' ),
				"category" => __( 'Category' , 'inbound-legacy-email-templates' ),
				"description" => __( 'Description' , 'inbound-legacy-email-templates' )
			);
...
"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?"',
		...
		*/
		public static function register_templates() {
			...
			/* Load Template Files */
			$inbound_email_templates = Inbound_Core_Email_Templates_Post_Type::load_template_files();
            Inbound_Core_Email_Templates_Post_Type::register_post_type();
            Inbound_Core_Email_Templates_Post_Type::register_category_taxonomy();
            ...
            Inbound_Core_Email_Templates_Post_Type::create_template( array(
				'id' => 'token-test',
				...
				'description' => __( 'Designed for testing & debugging tokens.' , 'inbound-legacy-email-templates' ) ,
            ...
            Inbound_Core_Email_Templates_Post_Type::create_template( array(
				...
				'description' => __( 'Designed for notifying administrator of new lead conversion when an Inbound Form is submitted.' , 'inbound-legacy-email-templates' ) ,
				'email_template_category' => 'inbound-core'
			));
            ...
            Inbound_Core_Email_Templates_Post_Type::create_template( array(
				...
				'title' => __( 'New User Signup Notification' , 'inbound-legacy-email-templates' ),
				'subject' => __( 'Your New Account - {{site-name}}' , 'inbound-legacy-email-templates' ),
				'body' => $inbound_email_templates['wp-new-user-notification'],
				'description' => __( 'WordPress core template for notifying	new users of their	created accounts.' , 'inbound-legacy-email-templates' ),
            ...
            Inbound_Core_Email_Templates_Post_Type::create_template( array(
				...
				'title' => __( 'New Comment Notification' , 'inbound-legacy-email-templates' ),
				'subject' => __( 'New Comment Posted - {{wp-post-title}} - {{site-name}}' , 'inbound-legacy-email-templates' ),
				'body' => $inbound_email_templates['wp-notify-post-author'],
				'description' => __( 'WordPress core template for notifying post authors of new comments.' , 'inbound-legacy-email-templates' ),
				'email_template_category' => 'wordpress-core'
			));
            ...
            Inbound_Core_Email_Templates_Post_Type::create_template( array(
				...
				'title' => __( 'New Comment Moderation' , 'inbound-legacy-email-templates' ),
				'subject' => __( 'Moderate Comment - {{wp-post-title}} - {{site-name}}' , 'inbound-legacy-email-templates' ),
				'body' => $inbound_email_templates['wp-notify-moderator'],
				'description' => __( 'WordPress core template for notifying post authors of new comments that need moderating.' , 'inbound-legacy-email-templates' ),
				'email_template_category' => 'wordpress-core'
			));
		...
		public static function load_template_files() {
			...
			include_once( INBOUND_EDIT_CORE_EMAIL_TEMPLATES_PATH . 'templates/inbound-new-lead-notification/inbound-new-lead-notification.php');
			include_once( INBOUND_EDIT_CORE_EMAIL_TEMPLATES_PATH . 'templates/wp-new-user-notification/wp-new-user-notification.php');
			include_once( INBOUND_EDIT_CORE_EMAIL_TEMPLATES_PATH . 'templates/wp-notify-post-author/wp-notify-post-author.php');
			include_once( INBOUND_EDIT_CORE_EMAIL_TEMPLATES_PATH . 'templates/wp-notify-moderator/wp-notify-moderator.php');
			include_once( INBOUND_EDIT_CORE_EMAIL_TEMPLATES_PATH . 'templates/token-test/token-test.php');
	...
	$GLOBALS['Inbound_Core_Email_Templates_Post_Type'] = new Inbound_Core_Email_Templates_Post_Type();
}
