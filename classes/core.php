<?php
/**
Class Name: Inbound_Core_Email_Templates_WPCore
...
if ( !class_exists( 'Inbound_Core_Email_Templates_WPCore' ) ) {

    class Inbound_Core_Email_Templates_WPCore {
     ...
     * Load Class
     */
    $Inbound_Core_Email_Templates_WPCore = new Inbound_Core_Email_Templates_WPCore( get_option('inbound_email_replace_core_template' , '1' ));
