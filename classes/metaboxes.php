...
if ( !class_exists( 'Inbound_Core_Email_Templates' ) ) {

    class Inbound_Core_Email_Templates {
        ...
        public static function display_restore_template() {
            global $Inbound_Core_Email_Templates_Post_Type, $post;
    ...
    $Inbound_Core_Email_Templates = new Inbound_Core_Email_Templates;
}